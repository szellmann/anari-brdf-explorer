...
anari::math::float3 Material::eval(anari::math::float3 Ng,
...
void Material::setSubtype(std::string_view subtype)
{
  using namespace visionaray;
...
void Material::setParameter(MaterialParam param)
{
  if (param.name == "color") {
...
MaterialParam Material::getParameter(std::string_view name)
{
  if (name == "color") {
